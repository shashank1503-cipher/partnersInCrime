...
<body>
    ...
    <h1 style="color:  #03DAC5;font-family: 'Source Code Pro', monospace; text-align: center;">Profile</h1>
    <?php
    require_once 'dbConfig.php';
    $username = $_GET['u'];
    $sql = "SELECT * FROM userdetails WHERE username = '$username'";
    ...
    echo '
    <div id = "imgContainer"><h1 style="font-family:\'Source Code Pro\';font-size: 7.5vh;">HELLO <br> THERE <br></h1></div>
    <div id = "center">
